...
if ( $_GET['mode'] == 'native' ) {
  ...
  $param_dump = print_r($params, TRUE);

  //print_r($params, true)

 
 // echo '<script>alert("$req_dump Server: $server_dump $post_dump \n=================\n\n")</script>';
...
// Generate JSON/JSONP string
  ...
  fwrite($fp, $req_dump."Param contains".$param_dump."\n\n");
  fwrite($fp, $req_dump."JSON contains".$json."\n\n");
  //fwrite($fp, ."headers contains".$headers."\n\n");
  //fwrite($fp, ."contents contains".$contents."\n\n");
  fclose($fp);

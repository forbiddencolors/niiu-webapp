...
// ############################################################################
$url = "http://dev.niiu.de/users/authenticate";
//$url="http://kirkthedev.com/niiu/request_dump.php?sss";
/*
$data = array("name" => "Hagrid", "age" => "36");                                                                    
$data_string = json_encode($data);   
$userReq='{"api":"user","action":"authentication","appGuid":"3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c","data":{"eMail":"kirk@niiu.de","password":"y0Xijiti"}}';
...
$myvars = 'myvar1=' . "pizza". '&myvar2=' . "tomatoes";
...
//$userReq='{"api":"user","action":"authentication","appGuid":"3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c","data":{"eMail":"kirk@niiu.de","password":"y0Xijiti"}}';
$userArray=array("eMail"=>"kirk@niiu.de","password"=>"y0Xijiti");
$authArray=array("api"=>"user","action"=>"authentication","appGuid"=>"3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c","data"=>$userArray);
$wrappedArray = array("data" => $authArray);                                                                    
$data_string = json_encode($wrappedArray);   
$userReq='{data:{"api":"user","action":"authentication","appGuid":"3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c","data":{"eMail":"kirk@niiu.de","password":"y0Xijiti"}}}';
$data_string='{"api":"user","action":"authentication","appGuid":"3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c","data":{"eMail":"kirk@niiu.de","password":"y0Xijiti"}}';
$wrappedString=json_encode(array("data"=> json_encode($data_string)));
$serverStyle="{data:json_encode($data_string)}";
$clean_str = preg_replace('/\\\"/',"\"", $wrappedString);
...
curl_setopt( $ch, CURLOPT_POST, true );
  ...
  $userReq = "{'data':{'api':'user','action':'authentication','appGuid':'3fc8274c-3ad4-4cc4-b5c6-9eaba0734a3c',
      'data':{
      'eMail': 'kirk@niiu.de',
      'password':'y0Xijiti'
      }
...
curl_setopt( $ch, CURLOPT_POSTFIELDS, $userReq );
...
if ( $_GET['mode'] == 'native' ) {
  ...
  //Kind of silly but the headers are put in at the top of the json content unless we do this to strip out everything before the first opening bracket
...
// Generate JSON/JSONP string
  //$json = json_encode( $data , JSON_UNESCAPED_SLASHES); //only works in php 5.4
